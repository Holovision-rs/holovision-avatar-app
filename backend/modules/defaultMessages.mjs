...
async function sendDefaultMessages({ userMessage }) {
  ...
  if (!userMessage) {
    messages = [
      ...
      {
        text: "I'm Torin, your personal AI virtual guardian. I'm here to help you with anything you need.",
  ...
  if (!elevenLabsApiKey || !openAIApiKey) {
    messages = [
      ...
      {
        text: "You don't want to ruin Torin with a crazy ChatGPT and ElevenLabs bill, right?",
